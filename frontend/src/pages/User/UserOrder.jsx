            ...
            {orders.map((order) => (
              ...
              className="hover:bg-gray-800/70 hover:shadow-lg transition-all duration-200 
                ...
                <img
                  ...
                  alt={order.user}
                  className="w-20 h-20 object-cover rounded-lg border-2 border-gray-600 shadow-md
                ...
                <td className="py-4 px-4 text-sm whitespace-nowrap text-gray-300">
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs text-gray-500">{new Date(order.createdAt).toLocaleTimeString('en-US', 
                ...
                <td className="py-4 px-4 text-center whitespace-nowrap">
                  {order.isPaid ? (
                   ...
                   bg-gradient-to-r from-green-500 to-green-600 rounded-full shadow-md">
                      ✅ Paid
                    </span>
                  ) : (
                    <span className="inline-flex items-center px-3 py-2 text-xs font-bold text-white
                     bg-gradient-to-r from-red-500 to-red-600 rounded-full shadow-md">
                      ❌ Pending
                    </span>
                  )}
                </td>
                ...
                <td className="py-4 px-4 text-center whitespace-nowrap">
                  <Link to={`/order/${order._id}`}>
                    <button className="bg-gradient-to-r from-pink-500 to-pink-600 text-white py-2.5 px-5 rounded-lg 
                      hover:from-pink-600 hover:to-pink-700 transform hover:scale-105 transition-all 
                      duration-200 shadow-lg font-semibold">
                      📄 View Details
                    </button>
                  </Link>
                </td>
