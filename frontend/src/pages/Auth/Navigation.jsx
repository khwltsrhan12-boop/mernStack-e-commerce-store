      ...
      <div className="flex flex-col space-y-2 pt-10">
        ...
        {[...mainLinks, cartLink, favoriteLink].map((link, index) => (
            ...
            >
                ...
                {/* اسم الرابط - يظهر عند فتح الشريط فقط */}
                {isSidebarOpen && (
      ...
      <div className="relative pb-4">
        ...
        >
            {userInfo ? (
                ...
                <Link to="/login" className="flex items-center text-gray-300 hover:text-pink-500 w-full h-full justify-center">
        ...
        {/* قائمة الخيارات المنسدلة (Dropdown) */}
          ...
          >
            ...
            <li>
              <button
                ...
                className="w-full flex items-center px-4 py-2 text-left text-red-400 hover:bg-gray-700 rounded-lg transition duration-200"
              >
        ...
        {!userInfo && isSidebarOpen && (
            <Link 
                to="/register" 
                className="flex items-center p-3 mt-2 rounded-lg font-semibold text-gray-300 hover:bg-gray-800 hover:text-pink-400"
            >
