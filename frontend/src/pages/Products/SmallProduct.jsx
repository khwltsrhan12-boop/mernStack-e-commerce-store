...
const SmallProduct = ({ product }) => {
  return (
    <div className="w-full bg-gray-900 rounded-xl shadow-xl border border-gray-800 
    hover:border-pink-600 transition duration-300 overflow-hidden mb-2 sm:mb-4">
